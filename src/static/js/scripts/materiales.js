...
$('.btnMostrar').click(function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            document.getElementById('nombre').innerHTML = response.material[0].nombre
            // document.getElementById('puesto').innerHTML = response.laborales[0].puesto
            document.getElementById('marca').innerHTML = response.material[0].marca
            document.getElementById('precio').innerHTML = response.material[0].precio
